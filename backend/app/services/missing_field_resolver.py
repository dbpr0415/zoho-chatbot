...
class MissingFieldResolver:
    ...
    @staticmethod
    def check_missing_fields(tool_name: str, raw_args: Dict[str, Any]) -> Tuple[bool, str]:
        """
        ...
        if missing:
            if "project_name" in missing and "task_name" in missing:
                return True, "I need both the project name and the task name. Could you provide them?"
